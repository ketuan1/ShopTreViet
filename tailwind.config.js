...
module.exports = {
	...
	theme: {
		...
		fontSize: {
			...
			base: ["clamp(16px,calc(16/1920*100rem),calc(16/1920*100rem))", , { lineHeight: "1.2" }],
			...
			"2xl": ["calc(24/1920*100rem)", { lineHeight: "calc(30/1920*100rem)" }],
			"3xl": ["calc(30/1920*100rem)", { lineHeight: "calc(40/1920*100rem)" }],
			"4xl": ["calc(32/1920*100rem)", { lineHeight: "calc(40/1920*100rem)" }],
			"5xl": ["calc(40/1920*100rem)", { lineHeight: "calc(48/1920*100rem)" }],
			"6xl": ["calc(48/1920*100rem)", { lineHeight: "calc(64/1920*100rem)" }],
			"7xl": ["calc(64/1920*100rem)", { lineHeight: "calc(72/1920*100rem)" }],
